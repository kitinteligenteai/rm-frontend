...
export const recipes = [
  {
    ...
    "name": "Picadillo de Res Tradicional",
    ...
    "instructions": [
      ...
      "Calienta la grasa en un sartén amplio. Sofríe la cebolla y el ajo.",
      "Añade el pimiento y cocina por 5 minutos.",
      "Incorpora la carne molida, sazona y cocina hasta que cambie de color.",
      "Licúa los jitomates y vierte la salsa sobre la carne.",
      "Agrega las calabacitas, tapa y cocina a fuego bajo por 15 minutos.",
      "Ajusta de sal y pimienta antes de servir."
    ],
    "tips_dante": {
      "estricto": "Este platillo es perfectamente compatible. Asegúrate de usar carne molida 80/20 para mayor saciedad.",
  ...
  },
  {
    ...
    "name": "Pollo en Salsa Verde con Nopales",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Licúa lo anterior con el cilantro y un poco del agua de cocción. Sazona con sal.",
      "Calienta la grasa en una cazuela y sella los cubos de pollo. Retíralos.",
      "En la misma cazuela, vierte la salsa y llévala a un hervor.",
      "Agrega los nopales cocidos y el pollo sellado. Cocina a fuego bajo por 10-15 minutos.",
      "Sirve caliente, decorado con cilantro y cebolla picada."
    ],
    "tips_dante": {
      "estricto": "Para un extra de vegetales, puedes añadir champiñones rebanados o espinacas al guiso.",
  ...
  },
  {
    ...
    "name": "Pescado a la Veracruzana (Adaptado)",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Sazona el filete de pescado con sal y pimienta.",
      "En un sartén, calienta el aceite de oliva y sofríe el ajo hasta que dore. Retíralo.",
      "En el mismo aceite, sofríe la cebolla y el pimiento hasta que suavicen.",
      "Añade el jitomate y el orégano. Cocina hasta que el jitomate suelte su jugo y se forme una salsa.",
      "Incorpora las aceitunas. Coloca el filete de pescado sobre la salsa.",
      "Tapa y cocina a fuego bajo por 10-12 minutos, o hasta que el pescado esté cocido y se desmenuce fácilmente.",
      "Sirve el pescado bañado en la salsa."
    ],
    "tips_dante": {
      "estricto": "Este platillo es ideal. Asegúrate de usar un buen aceite de oliva extra virgen para obtener todos sus beneficios.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Calienta la grasa en un sartén y acitrona la cebolla fileteada hasta que esté transparente y suave.",
      "Vierte la salsa de jitomate sobre la cebolla y cocina por 5 minutos.",
      "Añade el pollo deshebrado a la salsa. Mezcla bien y cocina por 5-10 minutos más para que los sabores se integren.",
      "Ajusta de sal si es necesario."
    ],
    "tips_dante": {
      "estricto": "Sirve la tinga sobre una cama de lechuga o dentro de mitades de aguacate para una comida perfectamente cetogénica.",
  ...
  },
  {
    ...
    "name": "Albóndigas en Caldillo de Chipotle",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Licúa los jitomates, el trozo de cebolla, el diente de ajo y el chipotle con un poco de agua. Sazona con sal.",
      "En una olla, vierte la salsa y llévala a hervor.",
      "Con cuidado, añade las albóndigas una por una a la salsa hirviendo.",
      "Agrega los cubos de calabacita o chayote.",
      "Tapa y cocina a fuego bajo por 20-25 minutos, hasta que las albóndigas y las verduras estén bien cocidas.",
      "Sirve caliente."
    ],
    "tips_dante": {
      "estricto": "Para asegurar que las albóndigas no se deshagan, puedes sellarlas en un sartén con un poco de grasa antes de meterlas a la salsa.",
  ...
  },
  {
    ...
    "name": "Bistec Encebollado con Champiñones",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Calienta 1 cda de grasa en un sartén a fuego alto. Sella los bistecs por ambos lados hasta el término deseado. Retíralos y resérvalos.",
      "En el mismo sartén, añade la otra cda de grasa. Agrega la cebolla fileteada y cocina a fuego medio-bajo, moviendo ocasionalmente, por 10-15 minutos hasta que esté suave y caramelizada.",
      "Añade el ajo y los champiñones. Sube el fuego y cocina hasta que los champiñones suelten su agua y se doren.",
      "Regresa los bistecs al sartén por un minuto para que se calienten y se impregnen del sabor.",
      "Sirve los bistecs cubiertos con la cebolla y los champiñones."
    ],
    "tips_dante": {
      "estricto": "Este platillo es ideal. La mantequilla o el ghee le dan un sabor espectacular a la cebolla caramelizada.",
  ...
  },
  {
    ...
    "name": "Lomo de Cerdo en Salsa Morita",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Remoja los chiles en agua caliente por 15 minutos para que se suavicen.",
      "Licúa los ingredientes asados (incluyendo los chiles remojados) con un poco del agua de remojo. Cuela la salsa para una textura más fina. Sazona con sal.",
      "Sazona los medallones de cerdo con sal y pimienta.",
      "Calienta la manteca en un sartén y sella los medallones por ambos lados.",
      "Vierte la salsa sobre la carne, tapa y cocina a fuego bajo por 15-20 minutos, hasta que el cerdo esté cocido y la salsa haya espesado.",
      "Sirve con una ensalada de nopales o aguacate."
    ],
    "tips_dante": {
      "estricto": "El chile morita tiene un dulzor natural, así que no necesita nada más. Es una excelente opción para variar el sabor.",
  ...
  },
  {
    ...
    "name": "Salmón en Costra de Hierbas y Limón",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "En un tazón pequeño, mezcla la harina de almendras, la ralladura de limón, el perejil, el ajo en polvo, sal y pimienta.",
      "Coloca el filete de salmón en una charola para hornear. Úntalo con la mantequilla derretida.",
      "Cubre la parte superior del salmón con la mezcla de harina de almendras, presionando ligeramente para que se adhiera.",
      "Hornea por 12-15 minutos, o hasta que el salmón esté cocido y la costra dorada.",
      "Sirve inmediatamente con espárragos o una ensalada verde."
    ],
    "tips_dante": {
      "estricto": "Este platillo es perfecto. El salmón es una fuente increíble de Omega-3 y la costra de almendras añade grasas saludables y fibra.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Una vez que la carne esté suave, añade las verduras más duras (como el chayote) y cocina por 10 minutos.",
      "Agrega las verduras más suaves (calabacita, ejotes) y cocina por 5-7 minutos más.",
      "Añade el cilantro al final y ajusta de sal.",
      "Sirve el caldo caliente con la carne y las verduras. Acompaña con limón, cebolla picada y chile serrano."
    ],
    "tips_dante": {
      "estricto": "Este caldo es una fuente increíble de nutrientes. Omite cualquier tubérculo como papa o elote. Usa tuétano para un extra de grasa saludable.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En un sartén grande, calienta la grasa a fuego medio y añade la cebolla. Cocina lentamente hasta que esté muy suave y caramelizada.",
      "Retira la cebolla del sartén.",
      "En el mismo sartén, sube el fuego y cocina los bistecs de hígado rápidamente, 1-2 minutos por lado. No lo sobre cocines o se pondrá duro.",
      "Regresa la cebolla al sartén y mezcla.",
      "Sirve inmediatamente, acompañado de aguacate."
    ],
    "tips_dante": {
      "estricto": "El hígado es un superalimento en la dieta cetogénica. Cómelo una vez por semana para un impulso de nutrientes.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Haz una incisión a lo largo y retira con cuidado las venas y semillas.",
      "Rellena los chiles con el queso.",
      "Bate las claras de huevo a punto de nieve. Incorpora las yemas de forma envolvente con una pizca de sal.",
      "Calienta la grasa en un sartén.",
      "Cubre cada chile relleno con la mezcla de huevo (capeado) y fríelo cuidadosamente por ambos lados hasta que esté dorado.",
      "Escúrrelos sobre papel absorbente y sírvelos calientes."
    ],
    "tips_dante": {
      "estricto": "Para evitar el exceso de grasa de la fritura, puedes hacerlos en una freidora de aire después de capearlos, rociando con un poco de aceite.",
  ...
  },
  {
    ...
    "name": "Cochinita Pibil (Versión Rápida)",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Coloca la carne de cerdo en una olla y vierte la marinada encima. Sazona con sal.",
      "Si usas hoja de plátano, pásala por el fuego para suavizarla y úsala para forrar la olla.",
      "Cocina a presión por 35-40 minutos o en olla de cocción lenta por 4-6 horas en bajo, hasta que la carne se deshebre fácilmente.",
      "Deshebra la carne y mézclala con sus jugos.",
      "Sirve con cebolla morada encurtida (cebolla fileteada con jugo de limón y sal)."
    ],
    "tips_dante": {
      "estricto": "Asegúrate de que la pasta de achiote no contenga harinas o azúcares añadidos. Sírvela en hojas de lechuga o sola.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Mientras, hierve los chiles y el jitomate. Licúalos con un poco de su agua de cocción y cuela la salsa.",
      "Vierte la salsa en la olla con la carne y su caldo. Llévalo a hervor.",
      "Añade el chayote y los ejotes. Cocina por 10 minutos.",
      "Agrega la calabacita y cocina por 5-7 minutos más.",
      "Sirve el caldo con la carne y las verduras, acompañado de limón."
    ],
    "tips_dante": {
      "estricto": "Este platillo es una excelente fuente de colágeno y nutrientes. Omite cualquier tubérculo como papa o elote. Usa tuétano para un extra de grasa saludable.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Para la vinagreta, mezcla en un tazón pequeño el aceite de oliva, el jugo de limón, el orégano, sal y pimienta.",
      "Vierte la vinagreta sobre la mezcla de carne y verduras. Revuelve bien.",
      "Justo antes de servir, incorpora suavemente los cubos de aguacate para que no se deshagan.",
      "Sirve inmediatamente."
    ],
    "tips_dante": {
      "estricto": "Este platillo es una ensalada completa y perfecta. Asegúrate de que la carne no se haya cocido con vegetales con almidón.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Calienta 1 cda de grasa en un sartén grande a fuego alto. Saltea el pollo hasta que esté cocido y dorado. Retíralo del sartén.",
      "En el mismo sartén, añade la otra cda de grasa. Saltea la cebolla y los pimientos hasta que estén suaves pero aún crujientes.",
      "Regresa el pollo al sartén y mezcla todo bien.",
      "Sirve caliente con guacamole, salsa y crema ácida."
    ],
    "tips_dante": {
      "estricto": "Sírvelo en un tazón o sobre hojas de lechuga. El guacamole es tu mejor aliado para añadir grasas saludables.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En un sartén grande, derrite la mantequilla a fuego medio. Añade el ajo y el chile de árbol. Cocina por 1-2 minutos hasta que el ajo esté fragante, pero no quemado.",
      "Sube el fuego, añade los camarones y cocínalos por 2-3 minutos, volteándolos una vez, hasta que estén rosados y opacos.",
      "Retira del fuego. Añade el jugo de limón y el perejil picado. Mezcla bien.",
      "Sirve inmediatamente con una ensalada fresca o arroz de coliflor."
    ],
    "tips_dante": {
      "estricto": "Este platillo es perfecto. La clave es usar mantequilla de buena calidad o ghee.",
  ...
  },
  {
    ...
    "name": "Chayotes Rellenos de Carne Molida",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Con una cuchara, retira parte de la pulpa, dejando una pared gruesa. Pica la pulpa que retiraste.",
      "En un sartén, calienta la grasa y sofríe la cebolla y el ajo. Añade la carne molida y cocina hasta que dore.",
      "Incorpora el jitomate picado y la pulpa de chayote. Sazona y cocina hasta que el líquido se evapore.",
      "Rellena las mitades de chayote con la mezcla de carne.",
      "Cubre con el queso rallado y gratina en el horno o freidora de aire."
    ],
    "tips_dante": {
      "estricto": "El chayote es un excelente sustituto de la papa, bajo en carbohidratos y muy versátil.",
  ...
  },
  {
    ...
    "name": "Sopa de Tortilla (Adaptada)",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Licúa todos los ingredientes asados con un poco del caldo de pollo. Cuela la mezcla para obtener un caldo terso.",
      "Vierte el caldo licuado en una olla y añade el resto del caldo. Sazona con sal y una rama de epazote. Cocina a fuego bajo por 15 minutos.",
      "Para servir, coloca una porción de pollo deshebrado en un tazón.",
      "Vierte el caldo caliente encima y corona con aguacate, chicharrón, queso, crema y cilantro."
    ],
    "tips_dante": {
      "estricto": "El chicharrón es el sustituto perfecto de las tiras de tortilla. Asegúrate de que la crema sea de buena calidad y sin azúcares.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Licúa el chile remojado, el vinagre, la pasta de achiote, el ajo y el jugo de piña (si lo usas). Sazona con sal.",
      "Marina los cubos de pescado en el adobo por al menos 20 minutos.",
      "Calienta la grasa en un sartén a fuego medio-alto. Saltea el pescado marinado hasta que esté cocido y ligeramente dorado.",
      "Sirve inmediatamente sobre hojas de lechuga, acompañado de cilantro, cebolla picada y salsa."
    ],
    "tips_dante": {
      "estricto": "Omite el jugo de piña para mantener los carbohidratos al mínimo. El sabor seguirá siendo delicioso.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En un sartén, calienta la grasa y sella las tiras de pollo hasta que estén doradas. Retíralas.",
      "En el mismo sartén, sofríe la cebolla hasta que esté transparente. Añade las rajas y cocina por un par de minutos.",
      "Incorpora la crema y calienta suavemente sin que hierva. Sazona con sal.",
      "Regresa el pollo al sartén. Mezcla todo y añade el queso.",
      "Cocina a fuego bajo hasta que el queso se derrita y la salsa espese ligeramente."
    ],
    "tips_dante": {
      "estricto": "Usa crema entera (heavy cream) o media crema para la versión más baja en carbohidratos.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Calienta la manteca en una olla y dora los trozos de carne por todos lados.",
      "Mientras, licúa los jitomates con la cebolla, el ajo y el chile.",
      "Vierte la salsa sobre la carne dorada. Tapa y cocina a fuego bajo por 20 minutos.",
      "Añade las calabacitas en cubos. Vuelve a tapar y cocina por 10-15 minutos más, hasta que las calabacitas estén suaves y la carne tierna.",
      "Ajusta de sal y sirve caliente."
    ],
    "tips_dante": {
      "estricto": "Este platillo es muy completo. Puedes añadir un poco de queso fresco desmoronado al servir para más grasa y proteína.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Añade el jitomate, la cebolla, el chile y el cilantro. Mezcla bien.",
      "Justo antes de servir, incorpora el aguacate en cubos y el jugo de limón.",
      "Sazona con sal y pimienta al gusto.",
      "Sirve sobre hojas de lechuga grandes a modo de tostada, o como relleno de aguacates."
    ],
    "tips_dante": {
      "estricto": "Prefiere el atún en aceite de oliva para un mayor aporte de grasas saludables. Este platillo es perfecto.",
  ...
  },
  {
    ...
    "name": "Costillas de Cerdo en Salsa Verde",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Mientras, hierve los tomates, cebolla, ajo y chiles.",
      "Licúa los ingredientes hervidos con el cilantro y un poco de su agua.",
      "En la misma olla donde sellaste las costillas, vierte la salsa y llévala a hervor.",
      "Regresa las costillas a la olla. Tapa y cocina a fuego muy bajo por 1.5 a 2 horas, o hasta que la carne se desprenda del hueso.",
      "Sirve caliente, acompañado de nopales o aguacate."
    ],
    "tips_dante": {
      "estricto": "Este platillo es una bomba de sabor y colágeno. La grasa de las costillas es parte del encanto y la saciedad.",
  ...
  },
  {
    ...
    "name": "Ensalada Cremosa de Pollo y Aguacate",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Corta la otra mitad del aguacate en cubos.",
      "Añade al tazón los cubos de pollo, la cebolla morada, el cilantro y los cubos de aguacate.",
      "Mezcla todo suavemente hasta que el pollo esté bien cubierto por el aderezo.",
      "Sirve sobre una cama de espinacas o dentro de hojas de lechuga."
    ],
    "tips_dante": {
      "estricto": "Esta receta es perfecta. Una forma deliciosa de alcanzar tus metas de proteína y grasa saludable.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Añade la calabacita, el chile chipotle entero y la rama de epazote.",
      "Cocina a fuego medio hasta que la calabacita esté suave.",
      "Retira el chile y el epazote si lo deseas.",
      "Para servir, coloca una base de pollo deshebrado en un tazón.",
      "Vierte el caldo caliente con las calabacitas.",
      "Corona con los cubos de aguacate y queso panela. Acompaña con cilantro y limón."
    ],
    "tips_dante": {
      "estricto": "Este platillo es ideal. El queso panela es una buena fuente de proteína. Asegúrate de que el caldo sea casero para evitar aditivos.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Calienta la grasa en un sartén a fuego alto y sella la carne hasta que esté dorada. Retírala del sartén.",
      "En el mismo sartén, sofríe la cebolla y el ajo hasta que estén transparentes.",
      "Añade el chile y cocina por un minuto.",
      "Incorpora el jitomate y cocina hasta que empiece a soltar su jugo.",
      "Regresa la carne al sartén y mezcla todo. Cocina por 5 minutos más para que los sabores se integren.",
      "Sirve caliente, acompañado de aguacate."
    ],
    "tips_dante": {
      "estricto": "Un platillo perfectamente balanceado y lleno de sabor.",
  ...
  },
  {
    ...
    "name": "Pollo en Salsa de Cacahuate",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "En un sartén seco, tuesta ligeramente los cacahuates y los chiles (con cuidado de no quemarlos).",
      "Licúa los cacahuates, los chiles, el ajo y una taza del caldo de pollo hasta obtener una salsa tersa y homogénea.",
      "En una olla, calienta un poco de grasa y vierte la salsa. Cocina a fuego bajo, moviendo constantemente, por 10 minutos. Si espesa mucho, añade más caldo.",
      "Añade las piezas de pollo a la salsa y cocina por 5 minutos más.",
      "Sirve caliente."
    ],
    "tips_dante": {
      "estricto": "Asegúrate de usar cacahuates naturales, no los que vienen fritos en aceites vegetales. Controla la porción, ya que es denso en energía.",
  ...
  },
  {
    ...
    "name": "Pescado Empapelado con Vegetales",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "Corta un rectángulo grande de papel aluminio o papel para hornear.",
      "En el centro, coloca una cama con la mitad de los vegetales.",
      "Coloca el filete de pescado encima. Sazona con sal y pimienta.",
      "Cubre el pescado con el resto de los vegetales y la ramita de epazote.",
      "Rocía con el aceite de oliva y el jugo de limón.",
      "Cierra el papel formando un paquete bien sellado por los bordes.",
      "Hornea por 15-20 minutos. El paquete se inflará.",
      "Abre con cuidado para no quemarte con el vapor. Sirve inmediatamente."
    ],
    "tips_dante": {
      "estricto": "Un platillo limpio, saludable y delicioso. Todos los ingredientes son perfectamente compatibles.",
  ...
  },
  {
    ...
    "name": "Carne en su Jugo (Estilo Dante)",
    "type": "Platillo Principal",
    ...
    "instructions": [
      ...
      "En la misma grasa, sella la carne picada.",
      "Mientras, licúa los tomatillos, la cebolla, el ajo y el cilantro con un poco del caldo de res.",
      "Vierte la salsa sobre la carne sellada. Añade el resto del caldo.",
      "Cocina a fuego bajo por 20-30 minutos, hasta que la carne esté muy suave y el caldo haya tomado sabor.",
      "Sirve caliente, coronado con el tocino crujiente, cebolla picada, cilantro y aguacate."
    ],
    "tips_dante": {
      "estricto": "Asegúrate de que el tocino no contenga azúcares añadidos. Este platillo es una bomba de sabor y saciedad.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Calienta la grasa en un sartén amplio y dora el pollo por todos lados. Retíralo.",
      "En el mismo sartén, a fuego bajo, sofríe los ajos fileteados y los aros de chile guajillo por 1-2 minutos, hasta que estén fragantes. Ten cuidado de no quemarlos.",
      "Regresa el pollo al sartén. Añade el caldo de pollo.",
      "Tapa y cocina a fuego bajo por 25-30 minutos, o hasta que el pollo esté completamente cocido y tierno.",
      "Sirve el pollo bañado en la salsa de ajo y chile."
    ],
    "tips_dante": {
      "estricto": "Un platillo lleno de sabor. El chile guajillo es muy bajo en picor y aporta muchos antioxidantes.",
  ...
  // --- PLATILLOS LIGEROS ---
  {
    ...
    "instructions": [
      ...
      "En otro sartén, calienta el resto de la grasa y estrella los huevos a tu gusto.",
      "Sirve los huevos en un plato y báñalos generosamente con la salsa ranchera caliente.",
      "Acompaña con rebanadas de aguacate y un poco de queso fresco o Cotija."
    ],
    "tips_dante": {
      "estricto": "Este platillo es un desayuno o cena perfecto. Evita las tortillas y usa el aguacate como tu base de grasa saludable.",
  ...
  },
  {
    ...
    "name": "Omelette de Espinacas y Queso de Cabra",
    "type": "Platillo Ligero",
    ...
    "instructions": [
      ...
      "Calienta la mitad de la mantequilla en un sartén antiadherente. Saltea las espinacas hasta que se hayan reducido. Retíralas.",
      "Añade el resto de la mantequilla. Vierte los huevos batidos y cocina a fuego medio-bajo.",
      "Cuando el omelette esté casi cuajado, coloca las espinacas y el queso de cabra sobre una mitad.",
      "Con una espátula, dobla la otra mitad sobre el relleno.",
      "Cocina por un minuto más y deslízalo sobre un plato."
    ],
    "tips_dante": {
      "estricto": "El queso de cabra es una excelente opción. Este platillo es una forma perfecta de empezar o terminar tu día.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Licúa lo anterior con el cilantro fresco y un poco del agua de cocción. Sazona con sal.",
      "En una olla, vierte la salsa y llévala a un hervor suave.",
      "Trocea el chicharrón con las manos y agrégalo a la salsa hirviendo.",
      "Cocina a fuego bajo por 10 minutos, o hasta que el chicharrón se haya suavizado a tu gusto.",
      "Sirve caliente, acompañado de cebolla picada y cilantro."
    ],
    "tips_dante": {
      "estricto": "Asegúrate de comprar chicharrón que solo sea piel de cerdo frita en su propia grasa, sin harinas añadidas. Es un platillo perfecto.",
  ...
  },
  {
    ...
    "name": "Machaca con Huevo a la Mexicana",
    "type": "Platillo Ligero",
    ...
    "instructions": [
      ...
      "Calienta la grasa en un sartén y sofríe la verdura picada hasta que la cebolla esté transparente.",
      "Añade la machaca y sofríe por un par de minutos para que se dore ligeramente y suelte su sabor.",
      "Bate los huevos en un tazón y viértelos sobre la machaca. Revuelve constantemente hasta que el huevo esté cocido a tu gusto.",
      "Sazona con sal (con cuidado, la machaca ya es salada) y pimienta."
    ],
    "tips_dante": {
      "estricto": "Platillo 100% compatible. Sírvelo con aguacate o un poco de queso de cabra para añadir más grasas saludables.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Añade la cebolla picada y sofríe en la grasa del chorizo hasta que esté transparente.",
      "Incorpora los nopales cocidos y escurridos. Mezcla bien y cocina por 5-7 minutos.",
      "Retira del fuego y añade el cilantro fresco.",
      "Sirve caliente, puedes acompañarlo con queso fresco y aguacate."
    ],
    "tips_dante": {
      "estricto": "Busca un chorizo de buena calidad, que sea solo carne y especias, sin rellenos de soya o harinas.",
  ...
  },
  {
    ...
    "name": "Ensalada Caprese con Aguacate",
    "type": "Platillo Ligero",
    ...
    "instructions": [
      ...
      "Esparce las hojas de albahaca fresca por encima.",
      "Justo antes de servir, rocía generosamente con el aceite de oliva extra virgen.",
      "Añade una pizca de sal gruesa y pimienta negra recién molida.",
      "Si lo usas, añade unas gotas de vinagre balsámico."
    ],
    "tips_dante": {
      "estricto": "Una ensalada perfecta, fresca y saciante. No escatimes en la calidad del aceite de oliva, es clave.",
  ...
  },
  {
    ...
    "name": "Huevos a la Cazuela con Espinacas",
    "type": "Platillo Ligero",
    ...
    "instructions": [
      ...
      "Engrasa una cazuelita o ramekin individual con mantequilla.",
      "Saltea los champiñones y las espinacas en un sartén hasta que se reduzcan. Sazona.",
      "Coloca los vegetales salteados en el fondo de la cazuelita.",
      "Vierte la crema sobre los vegetales.",
      "Con cuidado, casca los dos huevos sobre la cama de vegetales.",
      "Espolvorea el queso parmesano por encima.",
      "Hornea por 10-15 minutos, o hasta que las claras estén cuajadas y las yemas a tu gusto."
    ],
    "tips_dante": {
      "estricto": "Este platillo es una bomba de nutrientes y grasas saludables. Perfecto para cualquier comida del día.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Calienta la grasa en un sartén. Sofríe la cebolla y el chile.",
      "Añade el jitomate y cocina por un par de minutos.",
      "Incorpora el tofu desmenuzado y la cúrcuma (para darle color amarillo). Sazona.",
      "Cocina, moviendo ocasionalmente, por 5-7 minutos, hasta que el tofu esté caliente.",
      "Sirve caliente, con aguacate y cilantro."
    ],
    "tips_dante": {
      "estricto": "El tofu es una buena fuente de proteína vegetal. Asegúrate de que sea orgánico y no transgénico si es posible.",
  ...
  },
  {
    ...
    "name": "Sopa Cremosa de Champiñones",
    "type": "Platillo Ligero",
    ...
    "instructions": [
      ...
      "Añade los champiñones y cocina hasta que suelten su agua y comiencen a dorarse. Reserva algunos para decorar.",
      "Vierte el caldo. Lleva a hervor y luego reduce el fuego. Cocina por 15 minutos.",
      "Con una licuadora de inmersión, procesa la sopa hasta que esté completamente tersa.",
      "Regresa la sopa a la olla a fuego bajo. Incorpora la crema, moviendo constantemente. No dejes que hierva.",
      "Sazona con sal y pimienta.",
      "Sirve caliente, decorada con los champiñones reservados."
    ],
    "tips_dante": {
      "estricto": "Usa crema para batir (heavy cream) para la versión más baja en carbohidratos y más cremosa.",
  ...
  },
  {
    ...
    "name": "Aguacates Rellenos de Ensalada de Camarón",
    "type": "Platillo Ligero",
    ...
    "instructions": [
      ...
      "Añade la mayonesa y el jugo de limón. Mezcla bien. Sazona con sal y pimienta.",
      "Con una cuchara, retira un poco de la pulpa de cada mitad de aguacate para hacer el hueco más grande.",
      "Rellena generosamente las mitades de aguacate con la ensalada de camarón.",
      "Sirve inmediatamente, decorado con una hoja de cilantro."
    ],
    "tips_dante": {
      "estricto": "La clave es usar una mayonesa de buena calidad, hecha con aceite de aguacate o de oliva, o prepararla en casa.",
  ...
  // --- ANTOJOS SIN CULPA ---
  {
    ...
    "instructions": [
      ...
      "Cocina en el microondas a máxima potencia por 90 segundos.",
      "Desmolda con cuidado. Puedes rebanarlo y tostarlo en un sartén con mantequilla para una mejor textura."
    ],
    "tips_dante": {
      "estricto": "Esta receta es perfectamente estricta. Puedes hacer una versión salada añadiendo una pizca de sal y orégano, o una dulce con una gota de stevia y canela.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Mezcla a alta velocidad hasta obtener una consistencia completamente suave y cremosa, sin grumos de aguacate.",
      "Prueba y ajusta el dulzor si es necesario.",
      "Refrigera por al menos 30 minutos para que tome firmeza. Sirve frío."
    ],
    "tips_dante": {
      "estricto": "Asegúrate de que el cacao y la leche vegetal no contengan azúcares añadidos. Es un postre perfecto.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En un tazón, bate la mantequilla con el endulzante hasta que esté cremoso.",
      "Añade el huevo y la vainilla, y sigue batiendo.",
      "Incorpora la harina de almendras, el polvo para hornear y una pizca de sal. Mezcla hasta que se forme una masa.",
      "Añade las chispas de chocolate y mezcla de forma envolvente.",
      "Forma bolitas con la masa, colócalas en la charola y aplástalas ligeramente.",
      "Hornea por 12-15 minutos, o hasta que los bordes estén dorados.",
      "Deja enfriar completamente en la charola antes de moverlas, ya que son frágiles cuando están calientes."
    ],
    "tips_dante": {
      "estricto": "Usa chocolate con un porcentaje de cacao superior al 85% para menos azúcar y más antioxidantes.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Licúa a alta velocidad hasta que la mezcla esté completamente suave y sin grumos.",
      "Calienta la mantequilla en un sartén o comal a fuego medio-bajo.",
      "Vierte pequeñas porciones de la mezcla para formar los hot cakes.",
      "Cocina por 2-3 minutos por lado, o hasta que aparezcan burbujas en la superficie y los bordes estén secos. Voltea con cuidado.",
      "Sirve calientes con mantequilla y frutos rojos."
    ],
    "tips_dante": {
      "estricto": "Acompáñalos solo con mantequilla o un poco de canela. Evita los jarabes, incluso los “sin azúcar” comerciales.",
  ...
  },
  {
    ...
    "name": "Gelatina de Frutos Rojos y Crema",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Disuelve la grenetina hidratada en la 1.5 tazas de agua caliente. Añade el endulzante y mezcla.",
      "Coloca los frutos rojos en un molde y vierte la mezcla encima. Refrigera hasta que esté semi-cuajada.",
      "Para la capa de crema: Hidrata el sobre de grenetina. Calienta la crema/leche de coco con el endulzante. Disuelve la grenetina. Deja enfriar.",
      "Vierte cuidadosamente la mezcla de crema sobre la gelatina de frutos rojos semi-cuajada.",
      "Refrigera por al menos 4 horas o hasta que esté firme."
    ],
    "tips_dante": {
      "estricto": "Los frutos rojos son las frutas más bajas en azúcar, por lo que son la mejor opción para este estilo de vida.",
  ...
  },
  {
    ...
    "name": "Brownies de Chocolate Fudgy",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Derrite la mantequilla y el chocolate picado a baño maría o en el microondas. Mezcla hasta que esté suave.",
      "Añade el endulzante y mezcla bien.",
      "Incorpora los huevos uno por uno, batiendo bien.",
      "Agrega la harina de almendras, el cacao en polvo y el polvo para hornear. Mezcla solo hasta combinar.",
      "Vierte la mezcla en el molde y hornea por 20-25 minutos. El centro debe quedar un poco húmedo.",
      "Deja enfriar completamente en el molde antes de cortar."
    ],
    "tips_dante": {
      "estricto": "La alulosa funciona mejor en esta receta para una textura más húmeda y menos cristalización.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Divide la masa en 3 o 4 porciones y forma bolitas o discos planos.",
      "Calienta un sartén antiadherente a fuego medio-bajo.",
      "Coloca los panes de queso en el sartén y cocina por 4-5 minutos por lado, tapando el sartén.",
      "Estarán listos cuando estén dorados por fuera y cocidos por dentro."
    ],
    "tips_dante": {
      "estricto": "Una excelente opción para un antojo salado o para acompañar una comida.",
  ...
  },
  {
    ...
    "name": "Trufas de Chocolate y Aguacate",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "En un procesador de alimentos, mezcla la pulpa del aguacate hasta que esté completamente lisa.",
      "Añade el chocolate derretido y mezcla hasta que tengas una ganache espesa.",
      "Refrigera la mezcla por 30 minutos.",
      "Forma bolitas y revuélcalas en el cacao en polvo.",
      "Mantenlas en refrigeración hasta el momento de servir."
    ],
    "tips_dante": {
      "estricto": "Un postre perfecto, lleno de grasas saludables y antioxidantes.",
  ...
  },
  {
    ...
    "name": "Mini Cheesecakes sin Horno",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Para el relleno: Bate el queso crema con el endulzante, el jugo de limón y la vainilla.",
      "En otro tazón, bate la crema para batir hasta que forme picos firmes.",
      "Incorpora la crema batida a la mezcla de queso crema de forma envolvente.",
      "Vierte el relleno sobre las bases y refrigera por al menos 4 horas.",
      "Sirve frío, puedes decorar con frutos rojos."
    ],
    "tips_dante": {
      "estricto": "Un postre clásico adaptado a la perfección. Asegúrate de que el queso crema y la crema para batir sean enteros (full-fat).",
  ...
  },
  {
    ...
    "name": "“Tortillas” de Queso (Costras)",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Coloca un montoncito de queso rallado en el sartén, formando un círculo.",
      "Cocina por 2-4 minutos, hasta que los bordes comiencen a dorarse.",
      "Con una espátula, levanta la costra y dale la vuelta. Cocina 30 segundos más.",
      "Retírala y colócala sobre un rodillo para darle forma de taco mientras se enfría, o úsala plana como tostada."
    ],
    "tips_dante": {
      "estricto": "El vehículo perfecto para tus guisos. Cero carbohidratos, pura grasa y proteína.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En un tazón, bate las yemas con el queso crema y la sal hasta obtener una mezcla suave.",
      "En otro tazón, bate las claras con el crémor tártaro hasta que formen picos muy firmes (como para merengue).",
      "Con mucho cuidado, incorpora la mezcla de yemas a las claras batidas de forma envolvente.",
      "Coloca montoncitos de la mezcla sobre la charola, formando círculos.",
      "Hornea por 25-30 minutos, o hasta que estén dorados y firmes.",
      "Deja enfriar completamente antes de usar."
    ],
    "tips_dante": {
      "estricto": "Este pan es prácticamente cero carbohidratos. Ideal para cualquier momento.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Vierte la crema en el tazón frío y bate a velocidad media-alta hasta que comience a espesar.",
      "Añade el endulzante en polvo y la vainilla.",
      "Continúa batiendo hasta que se formen picos firmes. Ten cuidado de no batir de más o se convertirá en mantequilla.",
      "Úsala inmediatamente o guárdala en el refrigerador."
    ],
    "tips_dante": {
      "estricto": "Un toque de grasa y sabor para tus antojos. Mucho mejor que cualquier versión comercial.",
  ...
  },
  {
    ...
    "name": "Carlota de Limón (Adaptada)",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "En un refractario pequeño, coloca una capa delgada de la crema de limón.",
      "Cubre con una capa de galletas keto o pan nube.",
      "Repite las capas, alternando crema y galletas, terminando con una capa de crema.",
      "Refrigera por al menos 6 horas, o preferiblemente toda la noche, para que tome firmeza.",
      "Decora con más ralladura de limón antes de servir."
    ],
    "tips_dante": {
      "estricto": "Un postre delicioso. La acidez del limón lo hace muy refrescante.",
  ...
  },
  {
    ...
    "name": "Paletas de Hielo de Fresa con Crema",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Mezcla a alta velocidad hasta que la mezcla esté completamente suave.",
      "Prueba y ajusta el dulzor si es necesario.",
      "Vierte la mezcla en moldes para paletas de hielo.",
      "Inserta los palitos y congela por al menos 4-6 horas."
    ],
    "tips_dante": {
      "estricto": "Las fresas son una de las mejores frutas para este estilo de vida. Un antojo perfecto.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En un tazón, mezcla los ingredientes húmedos: mantequilla, huevos y crema ácida.",
      "En otro tazón, mezcla los ingredientes secos: harinas, endulzante y polvo para hornear.",
      "Vierte los ingredientes secos sobre los húmedos y mezcla hasta combinar.",
      "Vierte la masa en el molde y hornea por 30-40 minutos.",
      "Deja enfriar en el molde antes de desmoldar."
    ],
    "tips_dante": {
      "estricto": "Un antojo delicioso que te recordará al pan tradicional. Una rebanada es suficiente.",
  ...
  },
  {
    ...
    "name": "Mazapán de Almendra Casero",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Procesa por varios minutos. La mezcla primero parecerá seca, pero poco a poco los aceites de la almendra se liberarán y formarán una masa compacta.",
      "Coloca la masa en un molde para mazapán o simplemente forma discos con las manos.",
      "Presiona bien para compactar. Puedes comerlo inmediatamente."
    ],
    "tips_dante": {
      "estricto": "El antojo perfecto. Pura grasa saludable y sin aditivos.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "En una licuadora, vierte el café caliente, la mantequilla/ghee y el aceite MCT/coco.",
      "Tapa bien la licuadora (cubre el tapón con un paño para que escape el vapor).",
      "Licúa a alta velocidad por 20-30 segundos, hasta que esté espumoso y emulsionado, como un latte.",
      "Vierte en una taza y consume inmediatamente."
    ],
    "tips_dante": {
      "estricto": "Esta es una herramienta poderosa. Empieza con una cucharadita de aceite MCT para evaluar tu tolerancia digestiva.",
  ...
  },
  {
    ...
    "name": "Donas Horneadas con Canela",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "En un tazón, mezcla los ingredientes secos: harina, endulzante y polvo para hornear.",
      "En otro tazón, bate los huevos y la mantequilla derretida.",
      "Combina las dos mezclas hasta que estén integradas.",
      "Vierte la masa en los moldes, llenando hasta 3/4 de su capacidad.",
      "Hornea por 15-20 minutos. Deja enfriar un poco.",
      "Para la cubierta, mezcla el endulzante y la canela. Unta cada dona con mantequilla derretida y pásala por la mezcla."
    ],
    "tips_dante": {
      "estricto": "Un antojo delicioso. Recuerda que es un postre, consúmelo con moderación.",
  ...
  },
  {
    ...
    "instructions": [
      ...
      "Retira del fuego. Añade las semillas de chía, el endulzante y el jugo de limón.",
      "Mezcla bien y deja reposar por 10-15 minutos. Verás cómo la mezcla espesa.",
      "Guárdala en un frasco en el refrigerador. Dura hasta una semana."
    ],
    "tips_dante": {
      "estricto": "Perfecta para acompañar un pan nube, hot cakes keto o con queso crema.",
  ...
  },
  {
    ...
    "name": "Helado de Chocolate sin Máquina",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Bate la crema de coco hasta que esté suave y esponjosa.",
      "Añade el cacao, el endulzante y la vainilla. Bate hasta que todo esté incorporado.",
      "Vierte la mezcla en un recipiente apto para congelador.",
      "Congela por al menos 4-6 horas.",
      "Saca el helado del congelador unos 10-15 minutos antes de servir."
    ],
    "tips_dante": {
      "estricto": "Un postre increíblemente satisfactorio. Asegúrate de que la leche de coco y el cacao no tengan azúcares añadidos.",
  ...
  },
  {
    ...
    "name": "Caldo de Huesos Casero (Bone Broth)",
    "type": "Antojo sin Culpa",
    ...
    "instructions": [
      ...
      "Coloca los huesos asados en una olla grande o de cocción lenta. Cúbrelos con agua fría.",
      "Añade el vinagre de sidra de manzana. La acidez ayuda a extraer los minerales. Deja reposar por 30 minutos.",
      "Lleva a un hervor suave. Retira la espuma. Reduce el fuego al mínimo y añade vegetales/hierbas.",
      "Tapa y cocina a fuego muy bajo por un mínimo de 12 horas y hasta 24 horas (en olla lenta).",
      "Cuela el caldo para retirar todos los sólidos. Sazona con sal al gusto.",
      "Deja enfriar. La consistencia gelatinosa cuando está frío es la señal del éxito. Guárdalo en el refrigerador o congélalo."
    ],
    "tips_dante": {
      "estricto": "Esta es una de las herramientas más poderosas para tu salud. Tómalo solo o úsalo como base para tus sopas.",
