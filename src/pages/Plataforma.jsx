// src/pages/Plataforma.jsx (v6.0 - Menú con Guía Social)
...
import GuiaSocial from './GuiaSocial'; // <--- NUEVO IMPORT
    ...
    <div className="min-h-screen bg-slate-950 flex text-slate-100 font-sans">
      <aside className="w-72 bg-slate-900 border-r border-slate-800 hidden md:flex flex-col sticky top-0 h-screen">
        <div className="p-6">
          ...
          <nav className="space-y-1">
            ...
            <NavItem to="/plataforma/social" icon={PartyPopper} label="Guía Social" /> {/* <--- NUEVO ITEM */}
      ...
      <main className="flex-1 min-w-0 bg-slate-950 overflow-y-auto">
        ...
        <Routes>
          ...
          <Route path="social" element={<GuiaSocial />} /> {/* <--- NUEVA RUTA */}
